 ...
 * @author PC_LENOVO
 */
public class FormTabCorreioFiscalizacao extends javax.swing.JFrame {

    FiscalizacaoDAO d = new FiscalizacaoDAO();

    FiscalizacaoTableModel tableModel = new FiscalizacaoTableModel();

    public FormTabCorreioFiscalizacao(java.awt.Frame parent, boolean modal) {
        super();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        List<Fiscalizar> lista = d.buscarTudo();
        for (Fiscalizar s : lista) {
    ...
    private void txtProtocoloKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtProtocoloKeyPressed
        if (evt.getKeyCode() == evt.VK_ENTER) {
            ...
            List<Fiscalizar> lista = d.consultaPorProtocolo(Integer.parseInt(protocolo));
            for (Fiscalizar s : lista) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTabCorreioFiscalizacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormTabCorreioFiscalizacao dialog = new FormTabCorreioFiscalizacao(new javax.swing.JFrame(), true);
